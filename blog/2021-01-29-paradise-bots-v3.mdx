...
## The Current Docs
The current docs site `docs.paradisebots.net` will remain live as Paradise Docs v2 and anyone is free to remain using it, this (v3) site will use the domain you see
And be hosted in a sepetate location, we don't want to throw a whole bunch of major changes in your face at once so let's just keep it simple for now.
